 ...
 * Electron 模式：主进程 IPC push → setFftFrame，引用计数控制 IPC 开关。
 * 浏览器 Web 模式：WebAudioPlayer AnalyserNode poll → startFftPolling/stopFftPolling。
 *
...
import { startFftPolling, stopFftPolling } from "@/services/playback";
